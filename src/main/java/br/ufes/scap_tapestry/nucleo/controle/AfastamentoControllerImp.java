...
public class AfastamentoControllerImp implements AfastamentoController {
	...
	@Override
	public boolean salva(String nome_evento, String nome_cidade, TipoAfastamento tipo, Onus onusAfastamento, Date data_iniAfast, Date data_fimAfast, Date data_iniEvento, Date data_fimEvento, String motivo_afast) throws ParseException {
		...
		cal2.setTime((data_iniAfast));
		cal3.setTime((data_fimAfast));
		cal4.setTime((data_iniEvento));
		cal5.setTime((data_fimEvento));
